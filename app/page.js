  ...
  return (
    <>
      ...
      <main className="flex items-center text-dark w-full min-h-screen dark:text-light">
        <Layout className="pt-0 md:pt-16 sm:pt-8 pb-16">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <div className="flex items-center self-start mt-2 lg:self-center">
                ...
                <Link
                  ...
                  target="_blank"
                  className="ml-4 text-lg font-medium capitalize text-dark dark:text-light underline underline-offset-2 md:text-base"
                >
                  Contact
                </Link>
              </div>
        ...
        <div className="absolute right-8 bottom-0 inline-block w-24 md:hidden">
          <Image src={lightBuld} alt="vishwa" className="w-full h-auto" />
        </div>
      </main>
    </>
  );
