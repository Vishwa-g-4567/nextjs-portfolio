...
export const metadata = {
  title: "Vishwa | About",
  description:
    "Learn more about the developer behind this Next.js portfolio, highlighting expertise in building dynamic, high-performance web applications using React, server-side rendering, and API integration. Explore a passion for creating user-friendly, responsive, and optimized digital experiences.",
};
